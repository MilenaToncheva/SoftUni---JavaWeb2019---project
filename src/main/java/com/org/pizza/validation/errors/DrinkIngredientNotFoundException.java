...
public class DrinkIngredientNotFoundException extends RuntimeException {

    public DrinkIngredientNotFoundException() {
    }

    public DrinkIngredientNotFoundException(String message) {
        super(message);
