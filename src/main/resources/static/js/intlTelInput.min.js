    ...
    var b = function (a, b, c) {
        ...
        return function () {
            ...
            var l = function (a, b) {
                ...
                return e(d, [{
                    ...
                    key: "_f", value: function () {
                        ...
                        if (this.a.parentNode.insertBefore(b, this.a), this.k = this._e2("div", {"class": "flag-container"}, b), b.appendChild(this.a), this.selectedFlag = this._e2("div", {
                            "class": "selected-flag",
                            role: "combobox",
                    ...
                    key: "_v", value: function (a) {
                        var b = a, c = "1" === this.s.dialCode;
                        b && this.d.nationalMode && c && "+" !== b.charAt(0) && ("1" !== b.charAt(0) && (b = "1".concat(b)), b = "+".concat(b));
                        var d = this._5(b), e = this._m(b), f = null;
                        if (d) {
                            var g = this.q[this._m(d)], h = -1 !== g.indexOf(this.s.iso2),
                                i = "+1" === d && e.length >= 4;
                            if (!("1" === this.s.dialCode && this._w(e)) && (!h || i)) for (var j = 0; j < g.length; j++) if (g[j]) {
                                f = g[j];
                                break
                            }
            ...
            return a.intlTelInputGlobals.loadUtils = function (b) {
                ...
                return null
            }, a.intlTelInputGlobals.defaults = j, a.intlTelInputGlobals.version = "15.0.0", function (b, c) {
                var d = new n(b, c);
