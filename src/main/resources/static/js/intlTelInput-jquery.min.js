    ...
    var n = function (a, b) {
        ...
        return g(a, [{
            ...
            key: "_v", value: function (a) {
                ...
                if (d) {
                    var g = this.q[this._m(d)], h = -1 !== g.indexOf(this.s.iso2), i = "+1" === d && e.length >= 4;
